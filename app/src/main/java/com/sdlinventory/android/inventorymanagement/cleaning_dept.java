...
public class cleaning_dept extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.view_cleaning, container, false);

        context = this.getActivity();

        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getActivity());

        ProductName = databaseAccess.getProducts("Inventories",4);
        ProductPrice = databaseAccess.getProductPrice("Inventories",4);
        Brand = databaseAccess.getBrand("Inventories",4);
