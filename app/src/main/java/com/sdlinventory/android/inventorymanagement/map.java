...
//
//
//        CameraPosition Store = CameraPosition.builder().target(new LatLng(18.4575,73.8508)).zoom(16).bearing(0).tilt(45).build();
//
//        googleMap.moveCamera(CameraUpdateFactory.newCameraPosition(Store));
//    }
    ...
    public void onMapReady(GoogleMap googleMap)
    {
        ...
        latLng1=new LatLng(18.4575,73.8508);

        googleMap.addMarker(new MarkerOptions().position(latLng1).title("Store"));
