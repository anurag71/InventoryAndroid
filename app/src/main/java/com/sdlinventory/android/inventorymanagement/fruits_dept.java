...
public class fruits_dept extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.view_fruits, container, false);

        context = this.getActivity();

        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getActivity());

        ProductName = databaseAccess.getProducts("Inventories",5);
        ProductPrice = databaseAccess.getProductPrice("Inventories",5);
        Brand = databaseAccess.getBrand("Inventories",5);
