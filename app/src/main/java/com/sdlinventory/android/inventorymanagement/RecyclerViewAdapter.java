...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.ViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, ArrayList<RecyclerViewItemData> android) {
    ...
    public void onBindViewHolder(RecyclerViewAdapter.ViewHolder viewHolder, int i) {
        ...
        Picasso.with(context).load(android.get(i).getProduct_image()).resize(240, 120).into(viewHolder.img_android);
    }
