...
public class kitchen_dept extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.view_kitchen, container, false);

        context = this.getActivity();

        DatabaseAccess databaseAccess = DatabaseAccess.getInstance(getActivity());

        ProductName = databaseAccess.getProducts("Inventories",3);
        ProductPrice = databaseAccess.getProductPrice("Inventories",3);
        Brand = databaseAccess.getBrand("Inventories",3);
